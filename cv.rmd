...
CV <- create_CV_object(
  data_location = "/Users/yufangzhou/Dropbox/Personal Info/cv/",  
...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/miryo87s/cv/raw/master/cv.pdf)")
}
```
